...
(function () {
  ...
  root.innerHTML =
    ...
    ".logo{display:block;height:30px;width:auto}.sub{font-size:12px;opacity:.8;margin-top:5px}" +
    ...
    '<div class="head"><div><img class="logo" alt="Chaqui" src="' + LOGO + '"><div class="sub">Asistente de Ahumadores Chaquiro</div></div>' +
    '<div class="hb">' +
